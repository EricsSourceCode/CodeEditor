...
public class StringDictionaryLine
  ...
  private void resetSortIndexArray()
    {
    // It's not to arrayLast.  It's to the
    // whole length.
  ...
  private void resizeArrays( int toAdd )
    ...
    String[] tempKeyArray = new String[max +
                                         toAdd];
    String[] tempValueArray = new String[max +
                                         toAdd];
  ...
  public void sort()
    ...
    // The worst case scenario for this Bubble
    // Sort is if the very last item had to
  ...
  public String makeKeysValuesString()
    ...
    for( int count = 0; count < arrayLast;
                                        count++ )
      {
      // Using the sortIndexArray for the
      // sorted order.
      String oneLine = keyArray[
              sortIndexArray[count]] +
              "\t" +
